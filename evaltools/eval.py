...
if __name__ == '__main__':
    ...
    parser.add_argument("--pred_root", default='/dataset2/gjw/SDRNet/result/'+model_name)
    parser.add_argument("--GT_root", default='/dataset2/gjw/TestDataset')
